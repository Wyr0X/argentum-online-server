...
104         If .Counters.TimerMeditar >= IntervaloMeditar And .Counters.TiempoInicioMeditar > 20 Then
                If e_Class.Bard And .invent.Da̱oMagicoEqpObjIndex = CommonLuteIndex Then
                     ...
                     + ManaCommonLute
                ElseIf e_Class.Bard And .invent.Da̱oMagicoEqpObjIndex = MagicLuteIndex Then
                     Mana = Porcentaje(.Stats.MaxMAN, Porcentaje(PorcentajeRecuperoMana, RecoveryMana + .Stats.UserSkills(e_Skill.Meditar) * MultiplierManaxSkills)) _
                     + ManaMagicLute
                ElseIf e_Class.Bard And .invent.Da̱oMagicoEqpObjIndex = ElvenLuteIndex Then
                     Mana = Porcentaje(.Stats.MaxMAN, Porcentaje(PorcentajeRecuperoMana, RecoveryMana + .Stats.UserSkills(e_Skill.Meditar) * MultiplierManaxSkills)) _
                     + ManaElvenLute
                Else
