...
Public Const MsgCantPlaceCastleOnThisPos = 2076
Public Const MsgCantPlaceCastleOnThisMap = 2077
Public Const MsgAlreadyACastleOnThisMap = 2078
Public Const MsgYouStartedBuildingTheCastle = 2079
Public Const MsgGuildMemberStartedBuildingTheCastle = 2080
Public Const MsgToAttackCastleYouMustBeInAGuild = 2081
Public Const MsgCantAttackYourOwnCastle = 2082
Public Const MsgCastleAttacked = 2083
Public Const MsgOnlyDamageSpellsToCastle = 2084
Public Const MsgCastleInfo = 2085
Public Const MsgDamageToCastle = 2086
Public Const MsgCastleIsUnderAttack = 2087
Public Const MsgCastleGatesOpened = 2088
Public Const MsgCantWarpInThisMoment = 2089
Public Const MsgYouNeedToBeInAGuild = 2090
Public Const MsgYourGuildDoesntHaveCastle = 2091
Public Const MsgMustWaitXSecondsForWarpCastle = 2092
Public Const MsgCantAttackCastleBuilding = 2093
Public Const MsgCantAttackCastleDestroyed = 2094
Public Const MsgCastleDoneBuilding = 2095
Public Const MsgYourGuildAlreadyHasCastle = 2096
Public Const MsgYouAreAlreadyOnCastle = 2097
Public Const MsgYouWarpedToCastle = 2098
Public Const MsgWillArriveInCastleInXSeconds = 2099
Public Const MsgCantWarpToCastleIfNotAttacked = 2100
Public Const MsgCastleIntact = 2101
Public Const MsgCastleDamaged = 2102
Public Const MsgCastleDestroyed = 2103
Public Const MsgCastleCollapsed = 2104
Public Const MsgCastleBuilding = 2105
Public Const MsgEnteredCastle = 2106
Public Const MsgExitedCastle = 2107
Public Const MsgCastleEntranceCollapsing = 2108
Public Const MsgCastleEntranceCollapsed = 2109
Public Const MsgCastleInsideInfo = 2110
Public Const MsgCantWarpToCastleIfHpIsMoreThan = 2111
Public Const MsgYouMustBeAliveToEnterTheCastle = 2112
Public Const MsgCastleLostToGuild = 2113
Public Const MsgYourGuildConqueredTheCastle = 2114
Public Const MsgYouHaveStabbedFor = 2115
Public Const MsgCastleInvasionFailed = 2116
